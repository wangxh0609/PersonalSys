...
<body>
    <center>
        <table width="778" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" style="word-break:break-all">
            ...
            <tr>
                <td valign="top" bgcolor="#E59FD5"><jsp:include page="/WEB-INF/jsp/blog/admin/view/AdminLeft.jsp"/></td>
                        ...
                        %>
 						...
 						<%
 							if(wordSingle.getParentId()==-1){
 								out.print("<tr height='30'><td align='right' colspan='2'><a href="+basePath+"/sys/word_admin_delete?id="+wordSingle.getId()+">[删除留言及回复]</a></td></tr>");
 							}else{
 								out.print("<tr height='30'><td align='right' colspan='2'><a href="+basePath+"/sys/word_admin_delete?id="+wordSingle.getId()+">[删除留言]</a></td></tr>");
 							}
 						%>					
