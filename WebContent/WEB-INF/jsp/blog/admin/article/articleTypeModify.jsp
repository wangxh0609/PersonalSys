...
<jsp:useBean id="typeSingle" class="com.hust.docMgr.blog.domain.ArticleTypeBean" scope="request"/>
<html>
<head>
        ...
        <table width="778" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" style="word-break:break-all">
            ...
            <tr>
                ...
                <td align="center" valign="top">
                	<form action="<%=basePath %>/sys/article_admin_articleTypeModify" method="post">
                	...
                	<table border="0" width="99%" cellspacing="0" cellpadding="8">
                		...
                		<tr>
                			...
                			<td><input type="text" name="typeBean.typeName" value="<%=typeSingle.getTypeName() %>" size="50"></td>
                		</tr>
                   		<tr>
                			<td align="center">类别描述：</td>
                			<td><input type="text" name="typeBean.typeInfo" value="<%=typeSingle.getTypeInfo()%>" size="50"></td>
                		</tr>
                		<tr height="50">
