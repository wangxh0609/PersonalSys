        ...
        <table width="778" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" style="word-break:break-all">
            ...
            <tr>
                ...
                <td align="center" valign="top">
                    <form action="<%=basePath %>/sys/article_admin_addArticleType" method="post">
                	...
                	<table border="0" width="80%" cellspacing="0" cellpadding="8">
                		...
                		<tr>
                			...
                			<td><input type="text" name="typeBean.typeName" size="50"></td>
                		</tr>
	               		<tr>
                			<td align="center">类别描述：</td>
                			<td><input type="text" name="typeBean.typeInfo" size="50"></td>
                		</tr>
                		<tr height="50">
