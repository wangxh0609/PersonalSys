...
<body>
    <center>
        <table width="778" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" style="word-break:break-all">
            ...
            <tr>
                <td width="180"><jsp:include page="/WEB-INF/jsp/blog/admin/view/AdminLeft.jsp"/></td>
                <td align="center" valign="top">
                	<table border="0" width="540" cellspacing="0" cellpadding="0" rules="none">
						...
						%>
						<tr height="35">
							<td style="text-indent:20"><a href="<%=basePath %>/sys/friend_admin_adminSingleFriend?id=<%=single.getId() %>" class="word_purple "><%=single.getName()%></a></td>
							<td align="center"><%=single.getSex() %></td>
							<td align="center"><%=single.getOicq() %></td>
							<td align="center"><a href="<%=basePath %>/sys/friend_admin_friendModify?id=<%=single.getId() %>" class="word_purple ">√修改</a></td>
							<td align="center"><a href="<%=basePath %>/sys/friend_admin_deleteFriend?id=<%=single.getId() %>" class="word_purple ">×删除</a></td>							
						</tr>
						<%
    							}
							}
