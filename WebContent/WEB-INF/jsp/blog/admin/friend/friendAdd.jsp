        ...
        <table width="778" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" style="word-break:break-all">
            ...
            <tr>
                ...
                <td align="center" valign="top">
                	<form action="<%=basePath %>/sys/friend_admin_addFriend" method="post">                	
                	<table border="0" width="90%" height="300" cellspacing="0" cellpadding="8">
                		...
                		<tr>
                			...
                			<td><input type="text" name="friendBean.name" size="40"></td>
                		</tr>
                		<tr>
                			<td align="right">性&nbsp;&nbsp;别：</td>
                			<td>
								<input type="radio" name="friendBean.sex" value="男" class="noborder" checked="checked">男
								<input type="radio" name="friendBean.sex" value="女" class="noborder">女
                			</td>
                		</tr>
	               		<tr>
                			<td align="right">QQ号码：</td>
                			<td><input type="text" name="friendBean.oicq" size="40"></td>
                		</tr>
                		<tr>
                			<td align="right">BLOG：</td>
                			<td><input type="text" name="friendBean.blog" size="60"></td>
                		</tr>
                		<tr height="50">
