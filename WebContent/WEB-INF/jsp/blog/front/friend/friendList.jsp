	                ...
	                <table border="0" width="95%" style="margin-top:10" >
                		...
                		<% 
        		    		...
        		    		if(friendlist==null||friendlist.size()==0)
                       			...
                       			while(i<friendlist.size()){
                       				...
                       				String sexImg=request.getContextPath()+"/images/blog/";
	                    ...
	                    %>
 						<tr height="30">
 							...
 							<td align="center"><a href="<%=basePath %>/sys/friend_front_friendSingle?id=<%=friendSingle.getId()%>"><%=friendSingle.getName()%></a></td>
 							<td align="center" width="5%"><img src="<%=basePath %>/images/blog/hand.jpg"></td>
