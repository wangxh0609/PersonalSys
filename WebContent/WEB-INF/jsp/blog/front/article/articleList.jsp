                ...
                <td width="548" align="center" valign="top">
                    <table width="100%" height="55" border="0" cellsapcing="0" cellpadding="0" background="images/main_B.jpg">
                        <tr align="center" style="padding-bottom:10">
                        	...
                        	%>
                        	<td><a href="<%=basePath %>/sys/article_front_articleList?typeId=<%=single.getId() %>"><%=single.getTypeName() %></a></td>
                        	<%
                        			}
                        		}
                        	%>
                  	...
                  	<% 
            			...
            			if(articlelist==null||articlelist.size()==0)
                    		...
                    		if(articleSingle.getTypeId()==4)
                    			typeName="文章推荐";
                    		if(articleSingle.getTypeId()==5)
                    			typeName="日常活动";
                    		if(articleSingle.getTypeId()==6)
                    			typeName="休闲餐饮";
                        ...
                        %>
 						...
 						<tr height="30"><td style="text-indent:20" colspan="2"><a href="<%=basePath %>/sys/article_front_articleSingle?id=<%=articleSingle.getId()%>">阅读全文</a></td></tr>
 						<tr>
