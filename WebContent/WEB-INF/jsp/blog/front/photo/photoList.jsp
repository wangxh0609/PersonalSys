                    ...
                    <table border="0" width="95%" cellspacing="0" style="margin-top:10" >
                        ...
                        <%  
                        		...
                        		while(i<photoList.size()){
                        			...
                        			out.print("<a href='"+basePath+"/sys/photo_front_photoSingle?id="+photoSingle.getId()+"' target='_blank'><img src='/upload"+photoSingle.getPhotoAddr()+"' border='0' width='120' height='120' title='"+photoSingle.getPhotoInfo()+"' style='border:1 solid;border-color:black'></a> ");
                        			i++;
                        		}
                        		out.println("</td>");
                        		out.println("</tr>");
