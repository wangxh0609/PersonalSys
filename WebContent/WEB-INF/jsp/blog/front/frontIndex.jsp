...
<%@ page import="com.hust.docMgr.blog.domain.*" %>
<%
...
<body>
    <center>
        <table width="778" height="600" border="0" cellspacing="0" cellpadding="0" bgcolor="#F0EAED" style="word-break:break-all">
            <tr height="281"><td colspan="2"><jsp:include page="/WEB-INF/jsp/blog/front/view/FrontTop.jsp"/></td></tr>
            <tr>
                <td width="230" valign="top"><jsp:include page="/WEB-INF/jsp/blog/front/view/FrontLeft.jsp"/></td>
                <td width="548" align="center" valign="top">
                    <!-- 显示 我的文章 -->
                    <table border="0" width="94%" rules="none" cellspacing="0" cellpadding="8" style="margin-top:8">
                        <tr height="40">
                        	<td colspan="1" align="center">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp【我的文章】</td>
                        	<td align="right"><a href="<%=basePath %>/sys/article_front_articleList?typeId=1">更多..</a></td><!-- /sys/article_front_articleIndex -->
                        </tr>
                        <%
                        ...
                        %>
 						<tr>
 							<td class="tdg" colspan="2">
 								▲
	 							<a href="<%=basePath %>/sys/article_front_articleSingle?id=<%=articleSingle.getId()%>">
 						...
 						<tr><td style="text-indent:20" colspan="2"><a href="<%=basePath %>/sys/article_front_articleSingle?id=<%=articleSingle.getId()%>">阅读全文</a></td></tr>
 						<tr>
		                ...
		                <tr height="1"><td background="/images/blog/line.jpg" colspan="2"></td></tr>
                        <%
                        			i++;
                        		}
                        	}
                    ...
                    <table border="0" width="94%" rules="none" cellspacing="8" style="margin-top:10" >
						<tr height="40">
							...
							<td colspan="2" align="right"><a href="<%=basePath %>/sys/photo_front_photoList">更多..</a>
						</tr>
						<%
                        ...
                        <%  
                        		...
                        		while(i<photoList.size()){
			                        ...
			                        out.print("<td width='25%' style='border:1 solid'><a href='"+basePath+"/sys/photo_front_photoSingle?id="+photoSingle.getId()+"' target='_blank'><img src='/upload"+photoSingle.getPhotoAddr()+"' title='"+photoSingle.getPhotoInfo()+"' border='0' width='120' height='90'></a></td>");
                        			if((i+1)%4==0)
                        				out.print("</tr>");
                        			i++;
                        		}
