        ...
        <div class="p_d_1_1">
            <div class="content_info">
                ...
                <div class="search_art">
                    ...
                    <li>
                       	状态： <s:textfield value=""/>
                       	<!--<s:select name="complain.state" list="{nan,nv}" headerKey="" headerValue="全部"/>-->
                       	<!--<s:select name="complain.state" list="#complainStateMap" headerKey="" headerValue="全部"/>-->
                    </li>
                       ...
                       <s:iterator value="pageResult.items" status="st">
                            <tr <s:if test="#st.odd"> bgcolor="f8f8f8" </s:if> >
                               ...
                               <td align="center"><s:property value="#complainStateMap[state]"/></td>-->
                                 <!--  <td align="center"><s:property value="hahah"/></td>
                                <td align="center">
                                	<s:if test="state!=2">
